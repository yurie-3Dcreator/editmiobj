...
st.caption("ツールマニュアル: [こちら](https://yurie-craft.pro/?p=168)")
...
folder_path = st.text_input("2. worldフォルダパスを入力してください。アドレス情報の前後に記号や空欄が含まれていないかご確認お願いします。ネザー,エンドのworldフォルダは「DIM1」「DIM-1」になります。26.x以降は各dimensionsフォルダ「overworld」「the_end」「the_nether」を指定します。「Please enter the world folder path. ex.g:\minecraft_world\world", "")
if folder_path:
